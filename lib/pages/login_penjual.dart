...
class LoginPj extends StatefulWidget {
  @override
  _LoginPjState createState() => _LoginPjState();
}

class _LoginPjState extends State<LoginPj> {
  ...
  void _login() {
    ...
    if (username.isEmpty || password.isEmpty) {
      ...
      if (username == 'ghina' && password == '6701223045') {
        ...
        Navigator.pushNamed(context, '/homepage-penjual');
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, '/register-penjual');
                  },
